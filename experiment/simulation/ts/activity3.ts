...
function load_options() {
    let sel: HTMLSelectElement = <HTMLSelectElement> document.getElementById('name-dd');
...
function load_compositions() {
    let sel0: HTMLSelectElement = <HTMLSelectElement> document.getElementById('name-dd');
    let sel: HTMLSelectElement = <HTMLSelectElement> document.getElementById('composition-dd');
...
function show_temp_reading() {
    let dimmer: HTMLInputElement = <HTMLInputElement> document.getElementById('dimmer-inp');
    ...
    let label: HTMLLabelElement = <HTMLLabelElement> document.getElementById('show-dimmer-reading');

    let btn: HTMLButtonElement = <HTMLButtonElement> document.getElementById("dd-submit-btn");
