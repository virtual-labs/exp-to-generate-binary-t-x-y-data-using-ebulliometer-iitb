...
function verify_act6_inputs() {
    let val1: HTMLInputElement = <HTMLInputElement> document.getElementById(`mass-inp-1`);
    let val2: HTMLInputElement = <HTMLInputElement> document.getElementById(`mass-inp-2`);
    let val3: HTMLInputElement = <HTMLInputElement> document.getElementById(`moles-inp-1`);
    let val4: HTMLInputElement = <HTMLInputElement> document.getElementById(`moles-inp-2`);
    let val5: HTMLInputElement = <HTMLInputElement> document.getElementById(`moles-fraction-inp-1`);
    let val6: HTMLInputElement = <HTMLInputElement> document.getElementById(`moles-fraction-inp-2`);
