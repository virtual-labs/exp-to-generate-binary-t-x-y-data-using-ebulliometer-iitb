...
function verify_act7() {
    let val1: HTMLInputElement = <HTMLInputElement> document.getElementById(`g1`);
    let val2: HTMLInputElement = <HTMLInputElement> document.getElementById(`g2`);
    let val3: HTMLInputElement = <HTMLInputElement> document.getElementById(`ge`);
    let val4: HTMLInputElement = <HTMLInputElement> document.getElementById(`ratio`);
