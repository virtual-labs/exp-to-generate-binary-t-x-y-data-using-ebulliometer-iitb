...
let cp_btn_4;
let cp_btn_5;
let state_btn_1 = false;
let state_btn_2 = false;
let state_btn_3 = false;
let state_btn_4 = false;
let db_1;
let db_2;
let anim_btn;
let drop_img;
let smoke_img;
let bottom_cp;
let take_ls_reading = false;
let take_vs_reading = false;
let ts_div;
let ls_btn;
let vs_btn;
//selected values
...
function assign_all_images_and_elements() {
    ...
    cp_btn_1 = document.getElementById('cp-btn-1');
    cp_btn_2 = document.getElementById('cp-btn-2');
    cp_btn_3 = document.getElementById('cp-btn-3');
    cp_btn_4 = document.getElementById('cp-btn-4');
    cp_btn_5 = document.getElementById('cp-btn-5');
    db_1 = document.getElementById('db-1');
    db_2 = document.getElementById('db-2');
    anim_btn = document.getElementById('anim-btn');
    drop_img = document.getElementById('drop-img');
    smoke_img = document.getElementById('smoke-img');
    bottom_cp = document.getElementById('lower-cp');
    ...
    temp_text.font = '22%';
    ts_div = document.getElementById('take-sample-buttons');
    ls_btn = document.getElementById('ls-btn');
    vs_btn = document.getElementById('vs-btn');
...
function render_observation_table() {
    ...
    setTimeout(() => {
        let obs_body = document.getElementById('obs-tbody');
        obs_body.innerHTML = `
        <tr>
...
function verify_temp() {
    let inp = document.getElementById('temp-inp');
    let table_spinner = document.getElementById('spinner-tb');
